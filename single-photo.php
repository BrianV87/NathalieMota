...
if (have_posts()) :
    while (have_posts()) : the_post();
        ...
        // ----------------------------------------
        // Champs personnalisés (référence / année / type)
        // ----------------------------------------
        ...
        // ----------------------------------------
        // Navigation entre les photos d'une même catégorie
        // ----------------------------------------
        ...
        <main class="single-photo container">
            ...
            <div class="single-photo__row second-row">
                ...
                <div class="second-left">
                    ...
                    <a class="btn-contact"
                        data-modal="contact"
                        data-photo-ref="<?= esc_attr($reference) ?>">
                        Contact
                    </a>
                </div>
                ...
                <div class="second-right">
                    ...
                    <div class="second-arrows">
                        <?php if ($total > 1): ?>
                            <a href="<?= esc_url(get_permalink($prev_id)) ?>">
                                <img src="<?= esc_url(get_stylesheet_directory_uri() . '/assets/images/Line-6.png') ?>" alt="">
                            </a>
                            <a href="<?= esc_url(get_permalink($next_id)) ?>">
                                <img src="<?= esc_url(get_stylesheet_directory_uri() . '/assets/images/Line-7.png') ?>" alt="">
                            </a>
                        <?php endif; ?>
                    </div>
                </div>
